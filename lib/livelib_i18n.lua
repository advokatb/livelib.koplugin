...
-- Checks LiveLib .po files first, then delegates to KOReader gettext.
...
if lang ~= "en" and lang ~= "en_US" then
    local function try(name)
        ...
        if t and next(t) then
            ...
            logger.dbg("livelib i18n: loaded " .. path .. " — " .. n .. " strings")
            return t
        end
    end
    ...
    if translations then
        logger.dbg("livelib i18n: installed for language: " .. lang)
    end
end
